...
const navigation = {
  resources: [
    ...
    {
      name: "Support for your Project",
      href: PROJECT_SUBMISSION_LINK,
      target: "_blank",
    },
  ],
  social: [
        ...
        >
          ...
          <div className="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
            <div className="flex flex-col-reverse xl:flex-row justify-between items-center">
              ...
              <div className="flex flex-col xl:flex-row xl:flex-1 xl:justify-center">
                {Object.entries(navigation).map(
                  ([section, items]) =>
                    section !== "social" && (
                      <div
                        key={section}
                        className="w-full lg:w-[200px] text-center mt-12 lg:mt-0"
                      >
            ...
            <div className="mt-16 border-t border-white/10 pt-8 sm:mt-20 lg:mt-24">
              <div className="flex flex-col-reverse md:flex-row text-center lg:text-left justify-between">
                <p className="text-xs mt-8 md:mt-0 leading-5 text-gray-400">
                  &copy; 2024 Superteam Germany. All rights reserved.
                </p>
                <Link
                  href="/policy"
                  className="text-sm leading-6 text-gray-300 hover:text-white"
