...
export const agendaItems: AgendaItem[] = [
  ...
  },
  {
    ...
    type: "Panel",
    speakers: [
      "Ben Brophy (Solana Foundation, moderator)",
  ...
  },
  {
    ...
    type: "Panel",
    speakers: [
      "Radoslav Albrecht (Bitbond, moderator)",
      "Viktor Banh (DekaBank)",
      "Dolf Diederichsen (Hyphe)",
      "Jonas Konstandin (Midas)",
      "Erik Frank (LBBW)",
    ],
    location: "Main Stage",
    section: "Onchain Capital Markets",
  ...
  },
  {
    ...
    speakers: [
      "Newton Davis (Janus)",
      "Erik Plaumann (Bench)",
      "Alex Kujavsky (MultiHopper)",
      "João Martins (Housd)",
      "Maximilian Schneider (Bigwallet)",
  ...
  {
    time: "16:00 - 17:00",
    title: "Trading Cup Qualifier",
    type: "Trading Cup",
    speakers: [],
    location: "Jupiter Arena",
    section: "Trading Cup",
    status: "confirmed",
  },
  {
  ...
  },
  {
    ...
    speakers: [
      ...
      "Daniela Machado (Heartfelt)",
      "Daniel Burgmann (Ready)",
      "Norman Wiese (Coinbase / Onchain Growth Club)",
      "Ulrike Lierow Schad (Bundesblock, moderator)",
    ],
    location: "Main Stage",
    section: "Frontier Tech",
    status: "confirmed",
  ...
  {
    time: "18:20 - 18:30",
    title: "Jupiter Trading Cup Announcement and Closing",
    type: "Trading Cup",
