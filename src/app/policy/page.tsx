...
const policy = () => {
  return (
    <>
      <Nav />
      <section className="container  py-24 px-4 space-y-10">
        <h2>Privacy Policy</h2>

        <p>
          We are very delighted that you have shown interest in our enterprise.
          Data protection is of a particularly high priority for the management
          of the Superteam Germany. The use of the Internet pages of the
          Superteam Germany is possible without any indication of personal data;
        ...
        <p>
          ...
          the Superteam Germany. By means of this data protection declaration,
        ...
        <p>
          As the controller, the Superteam Germany has implemented numerous
        ...
        <h4>1. Definitions</h4>
        <p>
          The data protection declaration of the Superteam Germany is based on
        ...
        <p>Superteam Germany</p>
        <p>Möckernstrasse 120</p>
        <p>10963 Berlin</p>
        <p>Deutschland</p>
        <p>Phone: 01745732592</p>
        <p>Email: germany@superteam.fun</p>
        <p>Website: de.superteam.fun</p>

        <h4>3. Collection of general data and information</h4>
        <p>
          The website of the Superteam Germany collects a series of general data
        ...
        <p>
          When using these general data and information, the Superteam Germany
          ...
          prosecution in case of a cyber-attack. Therefore, the Superteam
          Germany analyzes anonymously collected data and information
        ...
        <p>
          On the website of the Superteam Germany, users are given the
        ...
        <p>
          The Superteam Germany informs its customers and business partners
          regularly by means of a newsletter about enterprise offers. The
          enterprise&#39;s newsletter may only be received by the data subject
        ...
        <p>
          The newsletter of the Superteam Germany contains so-called tracking
          ...
          pixel, the Superteam Germany may see if and when an e-mail was opened
          by a data subject, and which links in the e-mail were called up by
          data subjects.
        </p>
        ...
        <p>
          ...
          the controller. The Superteam Germany automatically regards a
        ...
        <ul className="space-y-4">
          ...
          <li>
            ...
            <p>
              ...
              Superteam Germany, he or she may, at any time, contact any
              employee of the controller. An employee of Superteam Germany shall
            ...
            <p>
              ...
              far as processing is not required. An employees of the Superteam
              Germany will arrange the necessary measures in individual cases.
            </p>
          </li>
          <li>
            ...
            <p>
              ...
              data stored by the Superteam Germany, he or she may at any time
              contact any employee of the controller. The employee of the
              Superteam Germany will arrange the restriction of the processing.{" "}
            </p>
          </li>
          <li>
            ...
            <p>
              ...
              may at any time contact any employee of the Superteam Germany.
            </p>
          </li>
          <li>
            ...
            <p>
              The Superteam Germany shall no longer process the personal data in
            ...
            <p>
              If the Superteam Germany processes personal data for direct
              ...
              objects to the Superteam Germany to the processing for direct
              marketing purposes, the Superteam Germany will no longer process
            ...
            <p>
              ...
              personal data concerning him or her by the Superteam Germany for
            ...
            <p>
              ...
              contact any employee of the Superteam Germany. In addition, the
          ...
          <li>
            ...
            <p>
              ...
              consent, the Superteam Germany shall implement suitable measures
            ...
            <p>
              ...
              contact any employee of the Superteam Germany.
            </p>
          </li>
          <li>
        ...
        <p>
          ...
          <a href="https://willing-able.com/">LegalTech</a> at Willing & Able
          that also developed the system for{" "}
          <a href="https://abletocontract.com/">esign document</a>. The legal
          texts contained in our privacy policy generator have been provided and
          published by{" "}
