...
const BuildStationIntro = () => {
  ...
  return (
    <div className="relative overflow-hidden">
      <motion.div
        style={{ y, x }}
        className="bg-[url('/images/line-wave-1.svg')] w-full absolute opacity-20 xl:opacity-100 h-[50vh] bg-no-repeat bg-right-bottom -z-50 bg-fixed bg-cover"></motion.div>
