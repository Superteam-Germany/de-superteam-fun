...
const partnerRows = [
  {
    ...
    slotClassName: "h-28 max-w-[430px]",
    partners: [
      {
  ...
  },
  {
    ...
    listClassName:
      "grid grid-cols-1 justify-items-center gap-y-10 sm:grid-cols-3 sm:gap-x-10 lg:gap-x-16",
    slotClassName: "h-24 max-w-[280px]",
    partners: [
      {
        name: "Tangem",
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://de.superteam.fun/solana-summit",
...
function Hero() {
  return (
    <section className="summit-hero-stage relative overflow-hidden bg-black">
      ...
      <div className="summit-container relative z-10 flex min-h-[min(680px,86svh)] flex-col items-center justify-center pt-24 text-center md:min-h-screen md:pb-0 md:pt-0">
        <p className="text-[20px] font-normal leading-none text-[#14f195] drop-shadow-[0_6px_24px_rgba(0,0,0,0.85)] sm:text-[22px] md:text-[30px]">
          13 June 2026 / Berlin
        </p>
        <h1 className="mt-5 max-w-[980px] text-[42px] font-light leading-[1.02] tracking-[-0.02em] text-[#c2bfca] drop-shadow-[0_10px_34px_rgba(0,0,0,0.9)] sm:text-[46px] md:text-[72px] lg:text-[84px]">
          Solana Summit Germany
        </h1>
        <SummitCta
          href={SOLANA_SUMMIT_LUMA_LINK}
          variant="solid"
          className="mt-8 h-[54px] w-full max-w-[340px] px-7 text-[13px] sm:max-w-[390px] sm:text-[15px]"
        />
      </div>
    </section>
  );
    ...
    <SummitReveal id="partners" className="summit-pattern-section py-20 lg:py-28">
      <div className="summit-container">
        <div className="summit-content-frame">
          ...
          <div className="mx-auto mt-14 max-w-[1100px] space-y-24 text-center">
            {partnerRows.map((row) => (
              <div key={row.label}>
                <p
                  className={`${row.labelClassName} text-sm font-semibold uppercase tracking-[0.32em]`}
                >
                  {row.label}
                </p>
                <div className={`mx-auto mt-12 ${row.listClassName}`}>
                  {row.partners.map((partner) => (
                    <a
                      ...
                      className={`${row.slotClassName} inline-flex w-full items-center justify-center opacity-80 transition duration-150 ease-out hover:-translate-y-0.5 hover:opacity-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#14f195] focus-visible:ring-offset-8 focus-visible:ring-offset-black`}
                    >
                      <Image
                        src={partner.image}
                        alt={partner.name}
                        ...
                        className={`${partner.logoClassName} h-auto w-auto object-contain`}
                      />
                    </a>
                  ))}
                </div>
              ...
              <div>
                ...
                <div className="mt-5 flex flex-col gap-3">
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-fit text-lg leading-tight text-[#14f195] no-underline transition-colors duration-150 ease-out hover:text-[#b9ffe7] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#14f195] focus-visible:ring-offset-2 focus-visible:ring-offset-black"
                  >
                    Michelberger Hotel
                  </a>
                  <a
    ...
    <SummitReveal className="summit-final-stage relative overflow-hidden bg-black px-6 py-28 text-center lg:py-36">
      ...
      <div className="relative z-10 mx-auto max-w-[960px]">
        ...
        <Image
          ...
          width={303}
          height={24}
          className="mx-auto mt-20 h-auto w-[142px] opacity-70 md:mt-12 md:w-[170px]"
        />
      </div>
    </SummitReveal>
  );
